...
Backend sistemler, gerçek zamanlı veri akışı (WebSocket) ve Yapay Zeka (RAG & Embedding) entegrasyonu üzerine odaklanan, dürüst mühendislik yaklaşımını ve sürekli gelişimi ilke edinmiş bir bilgisayar mühendisliği öğrencisiyim.
